...
Options to switch languages are clearly visible and easily accessible across all pages of the service. Users should not have to search or dig deep into settings to find this option. See the design pattern for [switching languages](../../service-patterns/design-patterns/language-switching.md).
...
Read more about [using frontend frameworks](../3.3-consistency/use-a-frontend-framework.md).

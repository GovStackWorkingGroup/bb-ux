...
Options to switch languages are clearly visible and easily accessible across all pages of the service. Users should not have to search or dig deep into settings to find this option. See the design pattern for [switching languages](../../service-patterns/7-page-templates/7.4-language-switching.md).
